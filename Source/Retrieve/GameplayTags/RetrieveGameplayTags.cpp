...
namespace RetrieveGameplayTags
{
	...
	UE_DEFINE_GAMEPLAY_TAG(GameplayEvent_Attack_HitSuccess_Burn, "GameplayEvent.Attack.HitSuccess.Burn");
	...
	UE_DEFINE_GAMEPLAY_TAG(GameplayEvent_Enemy_SpecialAttack_ProjectileFire, "GameplayEvent.Enemy.SpecialAttack.ProjectileFire");
	...
	UE_DEFINE_GAMEPLAY_TAG(Topic_Lumen_AskQuestions, "Topic.Lumen.AskQuestions");
	UE_DEFINE_GAMEPLAY_TAG(Topic_Lumen_KnowMe, "Topic.Lumen.KnowMe");
