...
namespace RetrieveGameplayTags
{
	...
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Ability_Player_BowAim);
	...
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Player_BowShot_Empowered);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Player_BowShot_Drawing);
	...
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Player_Aiming);
	...
	// ---- Element attunement (원소 공명 스택. 스택 GE의 GrantedTags로 부여되어 ElementResonanceComponent가 집계)
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Element_Attune);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Element_Attune_Fire);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Element_Attune_Water);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Element_Attune_Wind);

	// ---- Element resonance (공명 활성 상태 표시 + 배타 그룹)
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Resonance);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Resonance_Fire);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Resonance_Water);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Resonance_Wind);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Resonance_Mixed);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(State_Resonance_Trinity);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Resonance_Group);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Resonance_Group_Single);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Resonance_Group_Mixed);
	// 같은 원소 공명 I/II 배타용 (I과 II 동시 발동 방지, 다른 원소끼리는 공존)
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Resonance_Group_Fire);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Resonance_Group_Water);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Resonance_Group_Wind);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Resonance_Group_Trinity);

	// ---- Armor set (방어구 세트 식별. DT_Armor.ArmorSetTag / DT_ArmorSetBonus.SetTag)
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Armor_Set);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Armor_Set_Pyromancer);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Armor_Set_Guardian);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Armor_Set_Berserker);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Armor_Set_Hunter);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Armor_Set_Gale);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Armor_Set_Vampire);
	...
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(GameplayEvent_Enemy_SpecialAttack_ProjectileFire);
	...
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Consumable_Essence_Fire);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Consumable_Essence_Water);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Item_Consumable_Essence_Wind);
	...
	// 원소 공명 발동 시 버프 바 표기 (공명 GE의 AssetTag로 부착)
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Resonance);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Resonance_Fire);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Resonance_Water);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Resonance_Wind);
	// 공명 II 티어는 전용 아이콘을 쓰므로 버프칩 태그를 분리한다
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Resonance_Fire2);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Resonance_Water2);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Resonance_Wind2);
	...
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Berserker_2pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Berserker_4pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Gale_2pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Gale_4pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Guardian_2pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Guardian_4pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Hunter_2pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Hunter_4pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Pyromancer_2pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Pyromancer_4pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Vampire_2pc);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ArmorSet_Vampire_4pc);
	// 액티브 어드밴티지 버프 (패링/회피 모멘텀 GE의 AssetTag)
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_ParryMomentum);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_DodgeMomentum);
	// 원소 어튠 스택 진행도 칩 (ElementResonanceComponent가 수동 발행, ×N 표시)
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Attune_Fire);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Attune_Water);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(UI_Buff_Attune_Wind);
	...
	// ---- 빌드 스탯 SetByCaller (장비/공명/세트 GE + GE_InitStats 주입용)
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Init_NormalAttackMul);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Init_HeavyAttackMul);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Init_ElementalMul);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Init_CritChance);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Init_CritDamageMul);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Init_LifeSteal);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Init_ElementChargeGainMul);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Data_Init_OutgoingMul);
	...
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Topic_Lumen_CaveIntro);
	...
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Topic_Lumen_AskQuestions);
	RETRIEVE_API UE_DECLARE_GAMEPLAY_TAG_EXTERN(Topic_Lumen_KnowMe);
